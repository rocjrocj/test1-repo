 ...
 * Config for SMTP
 */
$mail->Host = "mail.rocjohnson.com."; // sets the SMTP server
$mail->Username = "rocjrocj"; // SMTP account username
$mail->Password = "rj3938rj3938"; // SMTP account password
...
$mail->SetFrom('roc@rocjohnson.com', 'Roc Johnson'); //from address
$mail->AddAddress("roc@rocjohnson.com", "Roc Johnson"); //where to send email